          ...
          <div className="relative z-10 max-w-2xl w-full space-y-8">
            ...
            >
              ...
              <p className="text-gray-400 text-sm md:text-base max-w-lg mx-auto leading-relaxed">
                Participe da distribuição global de taxas do ecossistema. Receba dividendos em USDT e eDollar em tempo real via Prova de Participação (Staking de eCoin) e Selo de Compromisso (CS).
              </p>
            </motion.div>
            ...
            {/* ================= DASHBOARD ECOSYSTEM METRICS CONNECTED ================= */}
            <div className="max-w-5xl mx-auto mt-12">
              <h2 className="text-3xl font-black mb-12 text-center tracking-tight">
                📊 Métricas do <span className="text-[#D4AF37]">Ecossistema</span>
              </h2>
