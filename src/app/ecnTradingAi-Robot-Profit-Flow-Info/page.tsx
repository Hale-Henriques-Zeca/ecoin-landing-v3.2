      ...
      <section className="px-6 py-24 bg-[#D4AF37] text-black">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl font-bold mb-12 max-w-3xl mx-auto">
            Veja o poder do nosso E-Coin Neural Bot: enquanto a tabela mostra o acúmulo de $0.01 por dia, o nosso <strong>E-Coin Neural Trading AI Robot faz $0.1 por cada MILISEGUNDO por ti</strong>. Não em segundos, minutos, nem horas. Imagine o poder desse Bot.
          </p>
