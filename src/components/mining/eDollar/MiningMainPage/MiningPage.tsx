...
import GasCapacityPanel from "@/components/mining/eDollar/MiningMainPage/Components/GasCapacityPanel";
import MiningHistoryPanel from "@/components/mining/eDollar/MiningMainPage/Components/MiningHistoryPanel";
...
export default function ShareholdersPage() {
  ...
  const menuItems = [
    { 
      ...
      label: "Participação", 
      icon: Cpu, 
      href: "/eCoinShareHolder/ParticipationTab" 
    },
    { 
      id: "recompensas", 
      label: "DIVIDENDOS", 
      icon: Gift, 
      href: "/eCoinShareHolder/ProfitTab" 
    },
    { 
      id: "stake", 
      label: "AÇÕES", 
      icon: Coins, 
      href: "/eCoinShareHolder/StakeTab" 
    },
    { 
      id: "cs_vault", 
      label: "SELOS", 
      icon: ShieldCheck, 
      href: "/eCoinShareHolder/CommitmentSealTab" 
    },
    { 
      id: "analytics", 
      label: "Métricas", 
      icon: BarChart3, 
      href: "/eCoinShareHolder/AnalyticsTab" 
    },
    { 
      id: "historico", 
      label: "HISTÓRICO", 
      icon: History, 
      href: "/eCoinShareHolder/HistoryTab" 
    },
    { 
      id: "portfolio", 
      label: "PORTFOLIO", 
      icon: Wallet, 
      href: "/eCoinShareHolder/PortfolioTab" 
    },
    { 
      id: "config", 
      label: "CONFIGURAÇÕES", 
